Подробный гайд по заданию 01 ветки DevOps Школы-21, полезный как для тех, кто впервые слышит о DevOps-е и Linux, так и для тех, кто с этим уже знаком.
...
- [X] Установка ОС в virtualbox - [гайд 00](00_INSTALL_SYSTEM.md "Установка ОС в virtualbox")
- [X] Сохранение и экспорт виртуальной машины - [гайд 01](01_EXPORT_AND_SAVE.md "Установка ОС в virtualbox")
- [X] Минимальная настройка системы - [гайд 02](02_SYSTEM_SETTING.md "Минимальная настройка системы")
- [X] Установка базового софта - [гайд 02](03_INSTALL_SOFT.md "Установка базовых программ")
